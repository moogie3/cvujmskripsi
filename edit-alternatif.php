		  ...
		  <div class="panel-body">
							<form role="form" method="post" action="edit.php?id=<?php echo $_GET['id'];?>">
                                    <div class="box-body">
                                       <?php
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alternatif" id="alternatif" style="pointer-events: none" placeholder="Alternatif Nama Karyawan" value="<?php echo $alt["alternatif"]?>">
                                        </div>
                                    ...
                                    <div class="box-footer">
										...
										<a href="karyawan.php" type="cancel" class="btn btn-warning">Cancel</a>
                                    </div>
                            </form>
							<?php
									}
