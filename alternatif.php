        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <?php if($_SESSION['level'] =='admin'){ ?><li class="active"><a href="#">Penilaian</a></li><?php } ?>
			...
			<tbody>
										<?php
												...
												while ($row = $kriteria->fetch_assoc()) {
													...
													?>
														  <?php if($_SESSION['level'] =='admin'){ ?><a href="edit-alternatif.php?id=<?php echo $row['id_alternatif'];?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a><?php } ?>
