	...
	<div class="container">
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-body table-responsive">
			<?php if($_SESSION['level'] =='admin'){ ?><a class='btn btn-default' href='add-karyawan.php'> Tambah Data Karyawan</a><?php } ?><br /><br />
			...
			<tbody>
										<?php
												...
												while ($row = $kriteria->fetch_assoc()) {
													...
													?>
														  <?php if($_SESSION['level'] =='admin'){ ?><a href="edit-karyawan.php?id=<?php echo $row['id_alternatif'];?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a><?php } ?>
